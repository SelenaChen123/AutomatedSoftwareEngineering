...
if __name__ == '__main__':
    ...
    examples.eg("synonyms", "checking repcols cluster", examples.eg_synonyms)
    examples.eg("reprows", "checking repreows", examples.eg_reprows)
    examples.eg("prototypes", "checking repreows cluster", examples.eg_prototypes)
    examples.eg("position", "where's wally", examples.eg_position)
    examples.eg("every", "the whole enchilada", examples.eg_every)
